    ...
    public static void main(String[] args) {
        try {
            List<SatisfactionAlgorithm> futoshikiCSPS = List.of(
                    ...
                    new BacktrackingSearch<Point, Boolean>( new BinaryCSP(Path.of("binary-futoshiki_dane_v1.0/binary_6x6"), 6)).withVariableSelection(MRV_MCV.class, STATIC).withValueSelection(LCV.class, STATIC),
                    new BacktrackingSearch<Point, Boolean>( new BinaryCSP(Path.of("binary-futoshiki_dane_v1.0/binary_6x6"), 6)).withVariableSelection(MRV_MCV.class, STATIC).withValueSelection(MPV.class, STATIC),
                    ...
                    new BacktrackingSearch<Point, Boolean>( new BinaryCSP(Path.of("binary-futoshiki_dane_v1.0/binary_8x8"), 8)).withVariableSelection(MRV_MCV.class, STATIC).withValueSelection(LCV.class, STATIC),
                    new BacktrackingSearch<Point, Boolean>( new BinaryCSP(Path.of("binary-futoshiki_dane_v1.0/binary_8x8"), 8)).withVariableSelection(MRV_MCV.class, STATIC).withValueSelection(MPV.class, STATIC),
                    ...
                    new BacktrackingSearch<Point, Boolean>( new BinaryCSP(Path.of("binary-futoshiki_dane_v1.0/binary_10x10"), 10)).withVariableSelection(MRV_MCV.class, STATIC).withValueSelection(LCV.class, STATIC),
                    new BacktrackingSearch<Point, Boolean>( new BinaryCSP(Path.of("binary-futoshiki_dane_v1.0/binary_10x10"), 10)).withVariableSelection(MRV_MCV.class, STATIC).withValueSelection(MPV.class, STATIC),

                    new ForwardChecking<Point, Boolean>( new BinaryCSP(Path.of("binary-futoshiki_dane_v1.0/binary_6x6"), 6)),
                    new ForwardChecking<Point, Boolean>( new BinaryCSP(Path.of("binary-futoshiki_dane_v1.0/binary_6x6"), 6)).withVariableSelection(MCV.class, STATIC),
                    ...
                    new ForwardChecking<Point, Boolean>( new BinaryCSP(Path.of("binary-futoshiki_dane_v1.0/binary_8x8"), 8)).withVariableSelection(MCV.class, STATIC),
                    ...
                    new ForwardChecking<Point, Boolean>( new BinaryCSP(Path.of("binary-futoshiki_dane_v1.0/binary_10x10"), 10)).withVariableSelection(MCV.class, STATIC),
                    ...
                    new BacktrackingSearch<Point, Integer>( new FutoshikiCSP(Path.of("binary-futoshiki_dane_v1.0/futoshiki_4x4"), 4)).withVariableSelection(MRV_MCV.class, STATIC).withValueSelection(LCV.class, STATIC),
                    new BacktrackingSearch<Point, Integer>( new FutoshikiCSP(Path.of("binary-futoshiki_dane_v1.0/futoshiki_4x4"), 4)).withVariableSelection(MRV_MCV.class, STATIC).withValueSelection(MPV.class, STATIC),
                    ...
                    new BacktrackingSearch<Point, Integer>( new FutoshikiCSP(Path.of("binary-futoshiki_dane_v1.0/futoshiki_5x5"), 5)).withVariableSelection(MRV_MCV.class, STATIC).withValueSelection(LCV.class, STATIC),
                    new BacktrackingSearch<Point, Integer>( new FutoshikiCSP(Path.of("binary-futoshiki_dane_v1.0/futoshiki_5x5"), 5)).withVariableSelection(MRV_MCV.class, STATIC).withValueSelection(MPV.class, STATIC),
                    ...
                    new BacktrackingSearch<Point, Integer>( new FutoshikiCSP(Path.of("binary-futoshiki_dane_v1.0/futoshiki_6x6"), 6)).withVariableSelection(MRV_MCV.class, STATIC).withValueSelection(LCV.class, STATIC),
                    new BacktrackingSearch<Point, Integer>( new FutoshikiCSP(Path.of("binary-futoshiki_dane_v1.0/futoshiki_6x6"), 6)).withVariableSelection(MRV_MCV.class, STATIC).withValueSelection(MPV.class, STATIC),


                    new ForwardChecking<Point, Integer>( new FutoshikiCSP(Path.of("binary-futoshiki_dane_v1.0/futoshiki_4x4"), 4)),
                    new ForwardChecking<Point, Integer>( new FutoshikiCSP(Path.of("binary-futoshiki_dane_v1.0/futoshiki_4x4"), 4)).withVariableSelection(MCV.class, STATIC),
                    ...
                    new ForwardChecking<Point, Integer>( new FutoshikiCSP(Path.of("binary-futoshiki_dane_v1.0/futoshiki_5x5"), 5)).withVariableSelection(MCV.class, STATIC),
                    ...
                    new ForwardChecking<Point, Integer>( new FutoshikiCSP(Path.of("binary-futoshiki_dane_v1.0/futoshiki_6x6"), 6)).withVariableSelection(MCV.class, STATIC),
            ...
            futoshikiCSPS.forEach(SatisfactionAlgorithm::satisfy);
